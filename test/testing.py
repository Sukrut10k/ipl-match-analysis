...
# Set Spark environment variables (adjust paths to match your system)
os.environ['SPARK_HOME'] = r'C:\spark'  # Change this to your Spark installation path
os.environ['HADOOP_HOME'] = r'C:\hadoop'  # Change this if you have Hadoop
os.environ['PYSPARK_PYTHON'] = sys.executable  # Use virtual env's Python

# Add Spark to Python path
sys.path.append(os.path.join(os.environ['SPARK_HOME'], 'python'))
sys.path.append(os.path.join(os.environ['SPARK_HOME'], 'python', 'lib', 'py4j-0.10.9.7-src.zip'))  # Adjust version
